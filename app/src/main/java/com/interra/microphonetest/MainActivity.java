...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        curVal= findViewById(R.id.curval);curVal.setTypeface(tf);
        ...
        playVolume = new PlayVolume(this);
        playVolume.init();
        PlayVolume.restId =R.raw.speaker_test;
    ...
    //Telefonlarda alta geri butonları varsa kapatır
